...
import com.WdkDrakor.WdkDrakorExtractor.invokeWdkDewasa
import com.WdkDrakor.WdkDrakorExtractor.invokeKisskh 
import com.WdkDrakor.WdkDrakorExtractor.invokeWdkmoviebox
import com.WdkDrakor.WdkDrakorExtractor.invokeWdkmoviebox2
import com.WdkDrakor.WdkDrakorExtractor.invokeGomovies
import com.WdkDrakor.WdkDrakorExtractor.invokeIdlix
import com.WdkDrakor.WdkDrakorExtractor.invokeMapple
import com.WdkDrakor.WdkDrakorExtractor.invokeSuperembed
import com.WdkDrakor.WdkDrakorExtractor.invokeVidfast
import com.WdkDrakor.WdkDrakorExtractor.invokeVidlink
import com.WdkDrakor.WdkDrakorExtractor.invokeVidsrc
import com.WdkDrakor.WdkDrakorExtractor.invokeVidsrccc
import com.WdkDrakor.WdkDrakorExtractor.invokeVixsrc
import com.WdkDrakor.WdkDrakorExtractor.invokeWatchsomuch
import com.WdkDrakor.WdkDrakorExtractor.invokeWyzie
import com.WdkDrakor.WdkDrakorExtractor.invokeXprime
import com.WdkDrakor.WdkDrakorExtractor.invokeCinemaOS
import com.WdkDrakor.WdkDrakorExtractor.invokePlayer4U
import com.WdkDrakor.WdkDrakorExtractor.invokeRiveStream
...
open class WdkDrakor : TmdbProvider() {
    override var name = "WdkDrakor"
    override val hasMainPage = true
    override var lang = "id"
    override val instantLinkLoWdkng = true
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val home = app.get("${request.data}$adultQuery&page=$page")
            ...
            } ?: throw ErrorLoWdkngException("Invalid Json reponse")
    ...
    override suspend fun load(url: String): LoadResponse? {
        val data = try {
            ...
            throw ErrorLoWdkngException("Invalid URL or JSON data: ${e.message}")
        } ?: throw ErrorLoWdkngException("Invalid data format")
        ...
        val res = app.get(resUrl).parsedSafe<MediaDetail>()
            ?: throw ErrorLoWdkngException("Invalid Json Response")
    ...
    override suspend fun loadLinks(
        ...
        runAllAsync(
            ...
            // Update: Menambahkan Wdkmoviebox2 sebagai salah satu Prioritas
            {
                invokeWdkmoviebox2(
            ...
            // 1. WdkDewasa (Asian Drama Priority)
            {
                invokeWdkDewasa(
                    res.title ?: return@runAllAsync,
                    res.year,
