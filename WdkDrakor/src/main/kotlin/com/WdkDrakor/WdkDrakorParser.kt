...
data class WdkDewasaSearchResponse(
    @JsonProperty("data") val data: ArrayList<WdkDewasaItem>? = arrayListOf(),
    @JsonProperty("success") val success: Boolean? = null
)

data class WdkDewasaItem(
    @JsonProperty("name") val name: String? = null,
    @JsonProperty("title") val title: String? = null,
...
// ================== WdkMOVIEBOX (OLD/V1) DATA CLASSES ==================
data class WdkmovieboxResponse(
    @JsonProperty("data") val data: WdkmovieboxData? = null,
)

data class WdkmovieboxData(
    @JsonProperty("items") val items: ArrayList<WdkmovieboxItem>? = arrayListOf(),
    @JsonProperty("streams") val streams: ArrayList<WdkmovieboxStreamItem>? = arrayListOf(),
    @JsonProperty("captions") val captions: ArrayList<WdkmovieboxCaptionItem>? = arrayListOf(),
)

data class WdkmovieboxItem(
    @JsonProperty("subjectId") val subjectId: String? = null,
    @JsonProperty("title") val title: String? = null,
    @JsonProperty("releaseDate") val releaseDate: String? = null,
...
data class WdkmovieboxStreamItem(
    @JsonProperty("id") val id: String? = null,
...
data class WdkmovieboxCaptionItem(
    @JsonProperty("lanName") val lanName: String? = null,
    @JsonProperty("url") val url: String? = null,
)

// ================== WdkMOVIEBOX 2 (NEW) DATA CLASSES ==================
data class Wdkmoviebox2SearchResponse(
    @JsonProperty("data") val data: Wdkmoviebox2SearchData? = null
)

data class Wdkmoviebox2SearchData(
    @JsonProperty("results") val results: ArrayList<Wdkmoviebox2SearchResult>? = arrayListOf()
)

data class Wdkmoviebox2SearchResult(
    @JsonProperty("subjects") val subjects: ArrayList<Wdkmoviebox2Subject>? = arrayListOf()
)

data class Wdkmoviebox2Subject(
    @JsonProperty("subjectId") val subjectId: String? = null,
    @JsonProperty("title") val title: String? = null,
    @JsonProperty("releaseDate") val releaseDate: String? = null,
...
data class Wdkmoviebox2PlayResponse(
    @JsonProperty("data") val data: Wdkmoviebox2PlayData? = null
)

data class Wdkmoviebox2PlayData(
    @JsonProperty("streams") val streams: ArrayList<Wdkmoviebox2Stream>? = arrayListOf()
)

data class Wdkmoviebox2Stream(
    @JsonProperty("id") val id: String? = null,
    @JsonProperty("url") val url: String? = null,
    @JsonProperty("format") val format: String? = null,
    @JsonProperty("resolutions") val resolutions: String? = null,
...
data class Wdkmoviebox2SubtitleResponse(
    @JsonProperty("data") val data: Wdkmoviebox2SubtitleData? = null
)

data class Wdkmoviebox2SubtitleData(
    @JsonProperty("extCaptions") val extCaptions: ArrayList<Wdkmoviebox2Caption>? = arrayListOf()
)

data class Wdkmoviebox2Caption(
    @JsonProperty("url") val url: String? = null,
    @JsonProperty("language") val language: String? = null,
    @JsonProperty("lanName") val lanName: String? = null,
